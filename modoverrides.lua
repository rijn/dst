return {
    ...
    ["workshop-624783401"] = { enabled = true,
        configuration_options =
        {
            StackSize = 40
        }
    ...
    --Portable cookpot
    ["workshop-614931358"] = { enabled = true },
    ...
    ["workshop-687193679"] = { enabled = true,
        configuration_options =
        {
            twigs_to_create = 10,
            twigs_to_create_a_log = 10
        }
    },

    --Craftable Marble
    ["workshop-740906983"] = { enabled = true },

    --Craftable Gears
    ["workshop-739170164"] = { enabled = true,
        configuration_options =
        {
            Science = 1,
            ["Gold Nugget"] = 0,
    ...
    ["workshop-373480109"] = { enabled = true },    --Coordinate

    --Super Wall DST
    ["workshop-785295023"] = { enabled = true,
        configuration_options =
        {
            language = "CHS",
            minimapicon = true,
    ...
    --Smarter Crock Pot Server Version
    ["workshop-829519717"] = {
        configuration_options = {
            Controller = false
        },
    ...
    --Gladius | Basic Sword
    ["workshop-909055399"] = { enabled = true },

    --Intelligent Ice Flingomatic
    ["workshop-934638020"] = { enabled=true },

    ["workshop-833060148"] = { enabled = true },    --Shiro
    ...
    ["workshop-907441365"] = { enabled = true },    --Rem
    ["workshop-908771355"] = { enabled = true }     --Ram
}
